...
$Trang_Thai_TT_ThangNay = $ThongTin_KH->data->customerInfo->invoice[0]->paid ? 'Đã thanh toán' : 'Chưa thanh toán';
...
$Trang_Thai_TT_ThangTruoc = $ThongTin_KH->data->customerInfo->invoice[1]->paid ? 'Đã thanh toán' : 'Chưa thanh toán'; 
...
$Trang_Thai_TT_ThangTruocNua = $ThongTin_KH->data->customerInfo->invoice[2]->paid ? 'Đã thanh toán' : 'Chưa thanh toán';
/*
...
/*
    ...
    "Tien_Dien_Thang_Truoc" => array(
		array(
			...
			"TrangThai_ThanhToan" => "$Trang_Thai_TT_ThangTruoc"
        )),
	"Tien_Dien_Thang_Truoc_Nua" => array(
		array(
			...
			"TrangThai_ThanhToan" => "$Trang_Thai_TT_ThangTruocNua"
